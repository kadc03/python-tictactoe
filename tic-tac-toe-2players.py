...
class Tic_Tac_Toe():
    def __init__(self):
        self.window = Tk()
        self.window.title('Cờ Caro - 2 người chơi')
    ...
    def display_gameover(self):
        ...
        score_text = 'Điểm \n'
        self.canvas.create_text(size_of_board / 2, 4 * size_of_board / 8, font="cmr 25 bold", fill=symbol_green_color, text=score_text)

        score_text = 'Người chơi 1 (X) : ' + str(self.X_score) + '\n'
        score_text += 'Người chơi 2 (O) : ' + str(self.O_score) + '\n'
        score_text += 'Hoà                      : ' + str(self.tie_score)
        self.canvas.create_text(size_of_board / 2, 3 * size_of_board / 5, font="cmr 20 bold", fill=symbol_green_color, text=score_text)
        self.reset_board = True

        score_text = 'Nhấn để chơi lại \n'
        self.canvas.create_text(size_of_board / 2, 15 * size_of_board / 16, font="cmr 25 bold", fill="gray", text=score_text)
